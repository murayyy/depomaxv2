...
document.getElementById("excelIndirBtn").addEventListener("click", () => {
  ...
  const basliklar = ["Ürün Kodu", "Ürün Adı", "Miktar", "Açıklama", "Reyon", "Barkod", "Toplandı", "Eksik"];
  const satirlar = liste.map((u) => [u.kod, u.ad, u.miktar || 0, u.aciklama, u.reyon, u.barkod, u.toplandi ? "Evet" : "", u.eksik ? "Evet" : ""]);
