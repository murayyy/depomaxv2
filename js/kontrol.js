  ...
  return `
    <div class="row-card ${durumSinifi(u)}" data-uid="${u.id}">
      ...
      <div class="row-card__grid">
        <div><div class="row-card__label">Miktar</div>${u.miktar || 0}</div>
...
document.getElementById("excelIndirBtn").addEventListener("click", () => {
  ...
  const basliklar = ["Ürün Kodu", "Ürün Adı", "Miktar", "Reyon", "Barkod", "Toplandı", "Eksik", "Kontrol", "Not"];
  const satirlar = liste.map((u) => [
    u.kod, u.ad, u.miktar || 0, u.reyon, u.barkod,
